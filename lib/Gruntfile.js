module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      build:{
        files:{
          '../dist/js/app.min.js': ['../data/app/*.js','../data/controllers/*.js','../data/directives/*.js','../data/factory/*.js']
        }
      }
    ...
    watch: {
      ...
      sassy: {
        files: ['../styles/sass/*.scss', '../styles/sass/partials/*.scss','../styles/sass/partials/p_cards/*.scss'],
        tasks: ['sass']
      }
